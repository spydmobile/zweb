...
const client = new mongodb_1.MongoClient("mongodb://sparcsadmin:usualAdminPass@mongodb.dss.intellifirenwt.com:27020/spyd_sense");
const db = client.db();
...
client.connect()
    ...
    (0, exports.readCurrentConditions)()
        ...
        fs.writeFileSync('dist/public/data.json', data);
        return;
    })
        .then(() => {
        (0, exports.readlast24)()
            ...
            fs.writeFileSync('dist/public/data24.json', data);
        })
            .then(() => {
